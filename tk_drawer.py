...
class TkDrawer:
    ...
    def draw_sqr(self, p, q, d, a):
        self.canvas.create_line(x(p), y(p), x(q), y(q), fill="green", width=2)
        self.canvas.create_line(x(q), y(q), x(d), y(d), fill="green", width=2)
        self.canvas.create_line(x(d), y(d), x(a), y(a), fill="green", width=2)
        self.canvas.create_line(x(a), y(a), x(p), y(p), fill="green", width=2)
        self.root.update()
